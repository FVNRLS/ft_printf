...
int main(void)
{
	...
	/* CHAR TEST WITH %%c */
	{
		...
		printf("===================================================================== \n");
		printf("'-' format modifier (adjust left) with field width 10 for %%c\n");
		printf("----------------------------------------------------------------------\n");
		ret1 = ft_printf("%-10c$, %-10c, THIS IS A PLAIN TEXT WITHOUT ANY FORMAT SPECIFIERS!\n", ch1, ch2);
		ret2 = printf("%-10c$, %-10c, THIS IS A PLAIN TEXT WITHOUT ANY FORMAT SPECIFIERS!\n", ch1, ch2);
		printf("Here the return of ft_printf: 	%d\n", ret1);
		printf("Here the return of printf: 	%d\n", ret2);
		printf("===================================================================== \n\n\n");
		
		printf("===================================================================== \n");
		printf("blank-padding with field width 10 for %%c\n");
		printf("----------------------------------------------------------------------\n");
		ret1 = ft_printf("%10c$, %10c, THIS IS A PLAIN TEXT WITHOUT ANY FORMAT SPECIFIERS!\n", ch1, ch2);
		ret2 = printf("%10c$, %10c, THIS IS A PLAIN TEXT WITHOUT ANY FORMAT SPECIFIERS!\n", ch1, ch2);
		printf("Here the return of ft_printf: 	%d\n", ret1);
	...
	/* PROCENT TEST WITH %% */
	{
		...
		printf("**********************************************************************\n\n");
		printf("===================================================================== \n");
		printf("'-' format modifier (adjust left) with field width 10 for %% sign\n");
		printf("----------------------------------------------------------------------\n");
		ret1 = ft_printf("%-10%$, %-10%, THIS IS A PLAIN TEXT WITHOUT ANY FORMAT SPECIFIERS!\n");
		ret2 = printf("%-10%$, %-10%, THIS IS A PLAIN TEXT WITHOUT ANY FORMAT SPECIFIERS!\n");
		printf("Here the return of ft_printf: 	%d\n", ret1);
		printf("Here the return of printf: 	%d\n", ret2);
		printf("===================================================================== \n\n\n");
		
		printf("===================================================================== \n");
		printf("blank-padding with field width 10 for %% sign\n");
		printf("----------------------------------------------------------------------\n");
		ret1 = ft_printf("%10%$, %10%, THIS IS A PLAIN TEXT WITHOUT ANY FORMAT SPECIFIERS!\n");
		ret2 = printf("%10%$, %10%, THIS IS A PLAIN TEXT WITHOUT ANY FORMAT SPECIFIERS!\n");
		printf("Here the return of ft_printf: 	%d\n", ret1);
		...
		printf("===================================================================== \n");
		printf("zero-padding with field width 10 for %% sign\n");
		printf("----------------------------------------------------------------------\n");
		ret1 = ft_printf("%010%$, %-010%, THIS IS A PLAIN TEXT WITHOUT ANY FORMAT SPECIFIERS!\n");
		ret2 = printf("%010%$, %-010%, THIS IS A PLAIN TEXT WITHOUT ANY FORMAT SPECIFIERS!\n");
		printf("Here the return of ft_printf: 	%d\n", ret1);
		printf("Here the return of printf: 	%d\n", ret2);
		printf("===================================================================== \n\n\n");
	}
	/* STRING TEST WITH %%s */
	{
		...
		printf("**********************************************************************\n\n");
		printf("===================================================================== \n");
		printf("'-' format modifier (adjust left) with field width 50 for %%s\n");
		printf("----------------------------------------------------------------------\n");
		ret1 = ft_printf("%-50s, %-50s, THIS IS A PLAIN TEXT WITHOUT ANY FORMAT SPECIFIERS!\n", str1, str2);
		ret2 = printf("%-50s, %-50s, THIS IS A PLAIN TEXT WITHOUT ANY FORMAT SPECIFIERS!\n", str1, str2);
		printf("Here the return of ft_printf: 	%d\n", ret1);
		printf("Here the return of printf: 	%d\n", ret2);
		printf("===================================================================== \n\n\n");
		
		printf("===================================================================== \n");
		printf("blank-padding with field width 10 for %%s\n");
		printf("----------------------------------------------------------------------\n");
		ret1 = ft_printf("%50s, %50s, THIS IS A PLAIN TEXT WITHOUT ANY FORMAT SPECIFIERS!\n", str1, str2);
		ret2 = printf("%50s, %50s, THIS IS A PLAIN TEXT WITHOUT ANY FORMAT SPECIFIERS!\n", str1, str2);
		printf("Here the return of ft_printf: 	%d\n", ret1);
	...
	/* INTEGER (BASE 10) TEST WITH %i and %d */
	{
		...
		printf("===================================================================== \n");
		printf("'+' format modifier with field width 10 for %%d\n");
		printf("----------------------------------------------------------------------\n");
		ret1 = ft_printf("%+10d, %+10i, %+10d THIS IS A PLAIN TEXT WITHOUT ANY FORMAT SPECIFIERS!\n", i, j, l);
		ret2 = printf("%+10d, %+10i, %+10d THIS IS A PLAIN TEXT WITHOUT ANY FORMAT SPECIFIERS!\n", i, j, l);
		printf("Here the return of ft_printf: 	%d\n", ret1);
		...
		printf("===================================================================== \n");
		printf("' ' format modifier (space) with field width 10 for %%d\n");
		printf("----------------------------------------------------------------------\n");
		ret1 = ft_printf("% 10d, % 10i, % 10d THIS IS A PLAIN TEXT WITHOUT ANY FORMAT SPECIFIERS!\n", i, j, l);
		ret2 = printf("% 10d, % 10i, % 10d THIS IS A PLAIN TEXT WITHOUT ANY FORMAT SPECIFIERS!\n", i, j, l);
		printf("Here the return of ft_printf: 	%d\n", ret1);
		...
		printf("===================================================================== \n");
		printf("'.' format modifier (precision) with field width 20 and 0 for %%d\n");
		printf("----------------------------------------------------------------------\n");
		ret1 = ft_printf("%.20d, %.020i, %.03d THIS IS A PLAIN TEXT WITHOUT ANY FORMAT SPECIFIERS!\n", i, j, l);
		ret2 = printf("%.20d, %.020i, %.03d THIS IS A PLAIN TEXT WITHOUT ANY FORMAT SPECIFIERS!\n", i, j, l);
		printf("Here the return of ft_printf: 	%d\n", ret1);
		printf("Here the return of printf: 	%d\n", ret2);
		printf("===================================================================== \n\n\n");
	}
	/* POINTER TEST WITH %%p*/
	{
		...
		printf("===================================================================== \n");
		printf("'-' format modifier (adjust left) with field width 10 and 20 for %%p\n");
		printf("----------------------------------------------------------------------\n");
		ret1 = ft_printf("%-10p, %-10p, %-20p %-20p THIS IS A PLAIN TEXT WITHOUT ANY FORMAT SPECIFIERS!\n", ptr1, ptr2, ptr3, ptr4);
		ret2 = printf("%-10p, %-10p, %-20p %-20p THIS IS A PLAIN TEXT WITHOUT ANY FORMAT SPECIFIERS!\n", ptr1, ptr2, ptr3, ptr4);
		printf("Here the return of ft_printf: 	%d\n", ret1);
		printf("Here the return of printf: 	%d\n", ret2);
		printf("===================================================================== \n\n\n");
		
		printf("===================================================================== \n");
		printf("blank-padding with field width 10 and 20 for %%p\n");
		printf("----------------------------------------------------------------------\n");
		ret1 = ft_printf("%10p, %10p, %20p %20p THIS IS A PLAIN TEXT WITHOUT ANY FORMAT SPECIFIERS!\n", ptr1, ptr2, ptr3, ptr4);
		ret2 = printf("%10p, %10p, %20p %20p THIS IS A PLAIN TEXT WITHOUT ANY FORMAT SPECIFIERS!\n", ptr1, ptr2, ptr3, ptr4);
		printf("Here the return of ft_printf: 	%d\n", ret1);
	...
	{
		int i 			= -214323; //-2147483648
		int j			= 0;
		unsigned int k 	= 4294967; //4294967295
		int	ret1;
		int	ret2;
		...
		printf("===================================================================== \n");
		printf("no format modifiers for %%u\n");
		printf("----------------------------------------------------------------------\n");
		...
		printf("===================================================================== \n");
		printf("'-' format modifier (adjust left) with field width 10 and 20 for %%u\n");
		printf("----------------------------------------------------------------------\n");
		ret1 = ft_printf("%-10u %-10u %-20u THIS IS A PLAIN TEXT WITHOUT ANY FORMAT SPECIFIERS!\n", i, j, k);
		ret2 = printf("%-10u %-10u %-20u THIS IS A PLAIN TEXT WITHOUT ANY FORMAT SPECIFIERS!\n", i, j, k);
		printf("Here the return of ft_printf: 	%d\n", ret1);
		printf("Here the return of printf: 	%d\n", ret2);
		printf("===================================================================== \n\n\n");
		
		printf("===================================================================== \n");
		printf("blank-padding with field width 10 and 20 for %%u\n");
		printf("----------------------------------------------------------------------\n");
		ret1 = ft_printf("%10u %10u %20u THIS IS A PLAIN TEXT WITHOUT ANY FORMAT SPECIFIERS!\n", i, j, k);
		ret2 = printf("%10u %10u %20u THIS IS A PLAIN TEXT WITHOUT ANY FORMAT SPECIFIERS!\n", i, j, k);
		printf("Here the return of ft_printf: 	%d\n", ret1);
		...
		printf("===================================================================== \n");
		printf("zero-padding with field width 10, 15 and 20 for %%u\n");
		printf("----------------------------------------------------------------------\n");
		ret1 = ft_printf("%015u %010u %020u THIS IS A PLAIN TEXT WITHOUT ANY FORMAT SPECIFIERS!\n", i, j, k);
		ret2 = printf("%015u %010u %020u THIS IS A PLAIN TEXT WITHOUT ANY FORMAT SPECIFIERS!\n", i, j, k);
		printf("Here the return of ft_printf: 	%d\n", ret1);
		printf("Here the return of printf: 	%d\n", ret2);
		printf("===================================================================== \n\n\n");

		printf("===================================================================== \n");
		printf("'.' format modifier (precision) with field width 10 and 20 for %%u\n");
		printf("----------------------------------------------------------------------\n");
		ret1 = ft_printf("%.15u %.10u %.20u THIS IS A PLAIN TEXT WITHOUT ANY FORMAT SPECIFIERS!\n", i, j, k);
		ret2 = printf("%.15u %.10u %.20u THIS IS A PLAIN TEXT WITHOUT ANY FORMAT SPECIFIERS!\n", i, j, k);
		printf("Here the return of ft_printf: 	%d\n", ret1);
		printf("Here the return of printf: 	%d\n", ret2);
		printf("===================================================================== \n\n\n");
	}
