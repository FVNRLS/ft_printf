...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   ft_convert_hex_lowercase.c                         :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: rmazurit <rmazurit@student.42heilbronn.    +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/04/12 16:54:32 by rmazurit          #+#    #+#             */
/*   Updated: 2022/04/19 18:43:22 by rmazurit         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

/* takes an int as input, convert it to unsigned int and converts it to a str 
with pf_calculate_hex. pf_putstr_hex prints the string to stdout'
